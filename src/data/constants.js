...
export const projects = [
  ...
  {
    id: 15,
    title: "Seamless Website Deployment on Tomcat Server with Jenkins CI/CD",
    date: "June 2024",
    ascdetails: [
      {
        name: "Devops Shacks",
    ...
    image:
      "https://media.licdn.com/dms/image/v2/D4D22AQFpZQWt9N2Luw/feedshare-shrink_1280/feedshare-shrink_1280/0/1719153349307?e=1727308800&v=beta&t=OLbB-lS2mE3nMpiocnazt74atUEH1C3FvS739go_GF4",
    tags: ["Jenkins"],
    category: "Jenkins",
  ...
  },
  {
    ...
    id: 12,
    title: " Ecommerce Microservice Application",
    date: "July 2024",
    ascdetails: [
      {
        name: "Devops Shacks",
    ...
    description2:
      "Kubernetes: Skilled in deploying and managing containerized applications.",
    description3:
    ...
    tags: ["Jenkins","Kubernetes","Microservice"],
    category: "Kubernetes",
  ...
  {
    id: 16,
    title: "Streamlining Boardgame Project with Azure CI/CD: Integrating Trivy, Maven, Docker, Kubernetes, and SonarQube",
    date: "July 2024",
    ascdetails: [
      {
        name: "Devops Shacks",
    ...
    tags: ["Azure CI-CD","Trivy","Maven","Docker","Kubernetes","SonarQube"],
  ...
  {
    id: 17,
    title: "Azure DevOps Full CI/CD Pipeline with AKS",
    date: "July 2024",
    ascdetails: [
      {
        name: "Devops Shacks",
  ...
  {
    id: 18,
    title: "Deploying a Node.js App with GitHub Actions and AWS ECS",
    date: "Aug 2024",
    ascdetails: [
      {
        name: "Devops Shacks",
    ...
    tags: ["Git-Action","ECR","ECS","Docker","Nginx","Rollback"],
  ...
  {
    id: 19,
    title: "Accelerating Deployment with GitHub Actions: 80% Reduction in Process Time",
    date: "Aug 2024",
    ascdetails: [
      {
        name: "Devops Shacks",
    ...
    tags: ["Git-Action","ECR","ECS","Docker"],
    category: "GitHub Action",
